...
class TestRunner(unittest.TestCase):
    ...
    def test___init___accepts_command_line_arguments(self):
        ...
        self.assertEquals(True, isinstance(self.runner.game, Game))
    ...
    def test_run_sets_up_config_options(self):
        ...
        self.assertEquals('fake stdin', Config.in_stream)
        self.assertEquals('fake stdout', Config.out_stream)
        self.assertEquals(0.6, Config.delay)
    ...
    def test_parse_options_accepts_directory(self):
        ...
        self.assertEquals('fakevalue', Config.path_prefix)
    ...
    def test_parse_options_accepts_integer_levels(self):
        ...
        self.runner.parse_options()
        self.assertEquals(42, Config.practice_level)
    ...
    def test_parse_options_accepts_skip(self):
        ...
        self.runner.parse_options()
        self.assertEquals(True, Config.skip_input)
    ...
    def test_parse_options_accepts_float_time(self):
        ...
        self.runner.parse_options()
        self.assertEquals(4.2, Config.delay)
